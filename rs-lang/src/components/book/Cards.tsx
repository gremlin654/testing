  ...
  return (
    <div>
      <Card sx={{ height: '550px' }}>
        ...
        <CardActions>
          <Button size='small' onClick={updateWord} data-name='deleted' data-word-name={word.word} id={word._id} value={`${difficult}`}>
        ...
        <CardContent>
          ...
          <Typography gutterBottom variant='h5' component='div'>
            ...
            <Sound
              onClick={() => {
                soundAudio.play()
                setTimeout(() => soundAudio1.play(), 800)
                setTimeout(() => soundAudio2.play(), 6000)
              }}
